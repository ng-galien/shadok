 ...
 * based on DependencyCache specifications.
 * 
 * This class handles the creation and management of PVCs that bind
 * to existing PVs to provide shared dependency caches.
 */
@KubernetesDependent
public class DependencyCachePvcDependent 
    ...
    @Override
    protected PersistentVolumeClaim desired(DependencyCache dependencyCache, Context<DependencyCache> context) {
