...
/**
 * DependentResource for managing PersistentVolumeClaim creation based on ProjectSource
 * specifications.
 *
 * <p>This class handles the creation and management of PVCs that bind to existing PVs to mount
 * project sources.
 */
@KubernetesDependent
